...
class WebotsQuadcopterNode:
  ...
  def bridgeLoop(self):
    # LISTENS on bridge_port and webots_rbx_bridge_quadcopter.py dials in,
    # instead of this node dialing out to a configured host -- see
    # rbx_webots_node.py's own 2026-09-21 bridgeLoop comment for the full
