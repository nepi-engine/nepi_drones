...
nepi_tunnel() {
    ...
    AUTOSSH_GATETIME=0 nohup autossh -M 0 -p 2222 -i ~/.ssh/nepi_default_ssh_key \
        ...
        -R 5760:127.0.0.1:5760 -R 5771:127.0.0.1:5771 -R 9021:127.0.0.1:9021 -R 9022:127.0.0.1:9022 -R 9023:127.0.0.1:9023 -R 9024:127.0.0.1:9024 -R 9025:127.0.0.1:9025 -R 9026:127.0.0.1:9026 -R 9027:127.0.0.1:9027 -R 9028:127.0.0.1:9028 -R 9041:127.0.0.1:9041 -R 9046:127.0.0.1:9046 -R 12222:127.0.0.1:22 \
