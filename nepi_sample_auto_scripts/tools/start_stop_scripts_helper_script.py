...
# GetScriptsQuery/GetRunningScriptsQuery/LaunchScript/StopScript service definitions and
# field names (scripts, running_scripts, script, success) are unchanged -- only the
# package moved.
